...
/**
 * Throws if the given academic year is archived. No-op if the year is
 * active, missing, or if there's no request context at all (a script/
...
function attachYearLockHooks(Model, { yearField = "academic_year_id" } = {}) {
  ...
  // cross-year writer (the save endpoints, migrations) already passes
  // skipYearLockCheck.
