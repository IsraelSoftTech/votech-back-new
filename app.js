...
const reportInventoryRouter = require("./routes/report-inventory");
const propertyEquipmentRouter = require("./routes/property-equipment");
...
app.use("/api/report-inventory", reportInventoryRouter);
app.use("/api/property-equipment", propertyEquipmentRouter);
